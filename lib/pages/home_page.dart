...
import 'package:jual_mobil/pages/search_page.dart';
import 'package:jual_mobil/shared/theme.dart';
import 'package:jual_mobil/widgets/list_car.dart';
      ...
      return Container(
        ...
        child: Column(
          children: [
            categories(),
            ListCar(
              listTitle: 'Mobil Murah Bekas',
              listDesc: 'Mobil Bekas Dibawah Rp 1.000.000',
              hasDesc: true,
            ),
            ListCar(
              listTitle: 'Penawaran Mobil Baru',
            ),
            ListCar(
              listTitle: 'Mobil Rekomendasi',
            ),
          ],
        ),
      );
